...
public class Main
{
    ...
    {
        if (!studentService.showSummary())  //NOT true = means there is no students enrolled
        {
            System.out.println("No Student Yet");
        }
        String displayStudents = studentService.studentSummary();
    ...
    private static void gradeStudent( StudentService studentService, Scanner scanner )
    {
        ...
        System.out.println( "Enrolled course:" + student.getEnrolledCourses() );
    ...
    private static void getCourse( CourseService courseService, Scanner scanner )
    {
        Course course = getCourseInformation( courseService, scanner );
        if ( course != null )
        {
    ...
    private static Course getCourseInformation( CourseService courseService, Scanner scanner )
    {
